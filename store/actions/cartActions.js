...
export const updateCartItem = (lineItemId, quantity) => (dispatch) =>
  updateCartItemSuccess(tempData);
// commerce.cart
 ...
 */
export const removeFromCart = (lineItemId) => (dispatch) => removeFromCartSuccess(tempData);
// commerce.cart
//   .remove(lineItemId)
//   .then((resp) => dispatch())
